...
export default function NewsRecentPostV2({
  postData,
}: {
  postData: INewPostTypes;
}) {
  return (
    <div className="py-[100px] bg-[#f2f2e3] md:py-[80px]" id="service-areas">
      <div className="container_big">
        {/* {serviceArea && (
          <div className="relative mb-[90px]">
            <div className="relative pb-[30px] border-solid border-b-[1px] text-center mb-[30px]">
              <h2>{serviceTitle} Service Areas</h2>
            </div>
            <ul className="grid grid-cols-12 ">
              {serviceData?.edges?.map((service) => (
                <li className="col-span-3 mb-[6px]" key={service?.node?.title}>
                  <a
        ...
        <div className="mb-[90px] text-center lg:mb-[50px] md:mb-[42px]">
          <h2 className="font-oswald font-light text-[64px] md:text-[34px] mb-[20px] text-primary leading-7 post_hding">
            FENCE POSTS
          </h2>
        </div>
        <div className="grid grid-cols-12 gap-y-[40px] gap-x-[114px] lg:gap-x-[15px] post_col">
            ...
            >
              <div className="relative h-full">
                ...
                <div className="pt-[30px] lg:pt-[20px]">
                  <h3 className="leading-[1.3] font-oswald text-black  font-regular text-[48px] mb-[20px] line-clamp-2 lg:!text-[28px]">
                    <a
                      href={`/fence-installation/${item?.node?.slug?.toLocaleLowerCase()}`}
                  ...
                  <p className="uppercase text-[20px] font-sourcesans font-bold text-[#939598] mb-[8px] lg:text-[16px]">
