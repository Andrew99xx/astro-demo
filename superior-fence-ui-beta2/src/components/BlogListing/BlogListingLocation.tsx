...
import type { IBlogListing, IFenceNewsLocationQueryData } from "../../graphql/generatedType/BlogListing.Types";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
const BlogListingLocation = ({ blogData, title="Fence News" }: { blogData: IFenceNewsLocationQueryData ,title?:string}) => {
              ...
              <AccordionContent className="!p-[10px]">
                <div>
                  ...
                  <ul className="flex flex-wrap gap-[1px] mt-6">
                    ...
                    {blog?.node?.categories?.edges?.map((tag) => (
                      <li
...
export default BlogListingLocation;
