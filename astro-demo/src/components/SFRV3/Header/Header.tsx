...
import CustomHambargarMenu from "../../SFRV2/CustomHambargarMenu/CustomHambargarMenu";
        ...
        {isLocationPage
          ? locationNavItems.map((item, index: number) => (
              ...
              >
                <a
                  href={item?.url}
                  className="uppercase text-[16px] font-sourcesans text-black font-bold"
                  key={index}
                >
                  {item?.name}
                </a>
...
const Header = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white relative min-h-[114px] lg:min-h-[76px]"
        ref={elementRef}
      >
        <div className="bg-[#a49e8d] py-3 lg:py-2 " />

        <div className="pr-10 flex items-center pl-[300px] main_nav lg:px-[15px] lg:pb-[17px] lg:pt-[15px]">
          <div className="bg-[#d2cfc7] py-[30px] px-[40px] absolute top-0 left-0 w-auto h-full flex items-center justify-center header_logo">
          ...
          <div className="flex items-center mx-auto lg:hidden">
            ...
            <div className="relative overflow-hidden ml-[25px]">
              <a
                href={quoteLink}
                className="text-white h-[50px] w-[179px] text-[15px]  font-sourcesans uppercase  font-bold bg-[#689689] tracking-[1px]   flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-primary hover:text-white"
              >
                Get Free Quote!
              </a>
            </div>
          ...
          <div className="flex items-center header_tel lg:hidden">
            <i className="leading-0">
              <CloudfrontImg
                src="https://superiorfence.s3.amazonaws.com/wp-content/uploads/2025/05/22113540/mobilev2.webp"
                alt="mobilev2"
                width={50}
                height={60}
              />
            ...
            <div className="pl-[10px]">
              <p className="text-[16px] text-black font-sourcesans">
                For a quality-built fence, <br /> call{" "}
                <a
                  href="tel:7048624941"
                  className="text-black font-bold font-sourcesans transition-all duration-300 ease-in-out hover:text-primary"
                >
                  (515) 644-2455
                </a>{" "}
                today!
          ...
          <div
            className={`hamburger_menu bg-white ${
              menuOpen ? "active flex flex-col min-h-[100svh]" : ""
            }`}
          >
            <div className="px-[20px] py-[30px]">
              ...
              <div className="flex justify-center mt-[20px]">
                <a
                  href={quoteLink}
                  className="text-white h-[50px] w-[179px] text-[15px]  font-sourcesans uppercase  font-bold  tracking-[1px] bg-[#689689]   flex items-center justify-center transition-all duration-300 ease-in-out hover:bg-primary hover:text-white"
                >
                  Get Free Quote!
                </a>
              </div>
            ...
            <div className="flex flex-wrap justify-center items-center flex-col py-[20px] bg-[rgba(0,0,0,.1)] mt-auto">
              <i className="leading-0">
                <img
                  src={assets.mobilev2}
                  alt="mobilev2"
