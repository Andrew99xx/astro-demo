    ...
    <div className="py-[100px] md:py-[80px]" id="estimate">
      <div className="container_big">
        <div className="flex md:flex-wrap items-start space-x-8 md:space-x-0">
          ...
          <div className="max-w-[482px] md:max-w-full w-full bg-[#a49e8d] py-4 px-[30px] sticky top-[104px] text-center frmRgt_cnt md:mt-[30px] md:ml-0 lg:!text-[16px] ">
            <div
              dangerouslySetInnerHTML={{
                __html:
                  data?.locationStates?.newLocationPurpose?.fenceQuoteDescription
              }}
...
export default GetFenceQuoteV3;
